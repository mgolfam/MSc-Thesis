function y = jpeg_compression( X, quality )

for component = 1:size(X, 3)
I = X(:, :, component);
I1=I;
[row coln]= size(I);
I= double(I);
...
%Display of Results
%----------------------------------------------------------
%figure(1);imshow(uint8(X));title('original image');
